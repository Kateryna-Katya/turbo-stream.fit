            ...
            <div class="legal-content">
                <div class="policy-hero-card" data-aos="fade-up" data-aos-delay="100">
                    <p>
                        ...
                        предоставляемые клиентами <strong><?= $domainTitle ?></strong>, как для оказания услуг по экспертному консалтингу, так и для других взаимодействий в электронном формате на территории ЕС.
                    </p>
                </div>
                ...
                <p data-aos="fade-up">
                    Для предотвращения утечки данных мы используем полный комплекс мер информационной безопасности. Уничтожение или блокирование данных осуществляется по запросу клиента или при достижении целей сбора, предусмотренных договором на обслуживание.
                </p>
                ...
                <div class="data-collection-grid">
                    ...
                    <div class="data-box" data-aos="fade-left">
                        ...
                        <ul class="legal-list">
                            <li>Имя пользователя / Представителя</li>
                            <li>E-mail и актуальный номер телефона</li>
                            <li>История запросов на консалтинговые услуги</li>
                        </ul>
                    </div>
                </div>
                ...
                <ul class="legal-list" data-aos="fade-up">
                    <li>Предоставление доступа к инновационной платформе развития.</li>
                    <li>Учет индивидуальных пожеланий при разработке новых консалтинг-решений.</li>
                ...
                <p data-aos="fade-up">
                    Файлы cookie позволяют нам анализировать трафик и сохранять ваши предпочтения (например, настройки региона Италия), чтобы сделать использование <strong><?= $fullDomain ?></strong> максимально эффективным. Вы всегда можете ограничить их использование в настройках своего браузера.
                </p>

                <div class="rights-block" data-aos="zoom-in">
                    <h2>Ваши права</h2>
                    <p>
                        Если вы хотите отредактировать свои данные или полностью прекратить их обработку, свяжитесь с командой <strong><?= $domainTitle ?></strong> напрямую:
                    </p>
